...
def run_train():
    ...
    save_path = r"D:\WZU_Models_Finetuned_news"

    # ====================== 1. 读取数据 ======================
    print("📥 加载数据...")

    # 加载训练集（用于训练）
    with open("data/news_train.json", encoding="utf-8") as f:
    ...
    # 加载验证集（用于训练过程中监控）
    with open("data/news_valid.json", encoding="utf-8") as f:
    ...
    args = Seq2SeqTrainingArguments(
        output_dir=r"D:\WZU_Train_Results_news",
